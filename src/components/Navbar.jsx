...
const Navbar = () => {
  ...
  return (
    <nav className='fixed mx-auto border border-[#33353f] top-0 left-0 right-0 z-50 bg-[#111827] bg-opacity-100'> 
        <div className='flex container lg:py-4 flex-wrap items-center justify-between mx-auto px-4 PY-2'>
        <Link href={"/"} className='text-2xl md:text-4xl text-white font-serif'>
